...
#
# # add this to /data/flume/conf/flume-env.sh
# echo "export FLUME_CLASSPATH=/data/w205/w205Project/flume/twitter4j-stream-2.2.6.jar:/data/w205/w205Project/flume/flume-sources-1.0-SNAPSHOT.jar" >> /data/flume/conf/flume-env.sh
#

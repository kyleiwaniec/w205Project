...
load_data <- function(){
  ...
  data <- dbGetQuery(con, "SELECT *  FROM  (SELECT DISTINCT 1 + trunc(random() * 5100000)::integer AS id FROM generate_series(1, 1100) g) r JOIN  twitters USING (id) LIMIT  1000;")
